...
@echo on
rem PowerShell.exe -ExecutionPolicy Bypass -File XEventSQLDiag.ps1 -ServerInstance %ServerName% -InternalOutFileName "%InternalOutFileName%" -OutputFileName "%OutputFileName%"
sqlcmd.exe -S %ServerName% -E -i .\XEventSQLDiag.sql -o "%InternalOutFileName%" -w2000 -v XEFileName="%OutputFileName%"
