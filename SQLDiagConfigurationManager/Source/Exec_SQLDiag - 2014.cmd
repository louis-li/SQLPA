...
"C:\Program Files\Microsoft SQL Server\120\Tools\Binn\SQLDiag.exe" /I "%CD%\SQLDiagWorkFolder\SQLDiagPTO2014.xml" /O "%CD%\SQLDiagOutput_%mydatetime%" /P "%CD%\SQLDiagWorkFolder"
