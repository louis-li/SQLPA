...
ECHO  Note that SQLdiag uses the local time on the computer where the utility is running.
"C:\Program Files\Microsoft SQL Server\110\Tools\Binn\SQLDiag.exe" /B _BeginTime_ /E _EndTime_ /I "%CD%\SQLDiagWorkFolder\SQLDiagPTO2016.xml" /O "%CD%\SQLDiagOutput_%mydatetime%" /P "%CD%\SQLDiagWorkFolder"
