...
ECHO  Note that SQLdiag uses the local time on the computer where the utility is running.
"C:\Program Files\Microsoft SQL Server\120\Tools\Binn\SQLDiag.exe" /B 13:10:00 /E 13:15:00 /I "%CD%\SQLDiagWorkFolder\SQLDiagPTO2014.xml" /O "%CD%\SQLDiagOutput_%mydatetime%" /P "%CD%\SQLDiagWorkFolder"
